...
/**
 * Persistent queue-visibility banner (iAuditor/Fieldwire pattern): the
 * technician can always see whether anything is waiting to sign and force a
 * drain. Renders nothing when online with an empty queue.
 */
